...
namespace Bug.Logic.Service.Fhir
{
  public class OperationOutcomeSupport : IOperationOutcomeSupport
  {
    ...
    /// <returns></returns>
    public Common.FhirTools.FhirResource GetError(Common.Enums.FhirVersion fhirMajorVersion, string[] errorMessages)
    {
    ...
    /// <param name="errorMessages"></param>
    /// <returns></returns>
    public Common.FhirTools.FhirResource GetFatal(Common.Enums.FhirVersion fhirMajorVersion, string[] errorMessages)
    {
      switch (fhirMajorVersion)
      {
        case Common.Enums.FhirVersion.Stu3:
    ...
    /// <param name="errorMessages"></param>
    /// <returns></returns>
    public Common.FhirTools.FhirResource GetWarning(Common.Enums.FhirVersion fhirMajorVersion, string[] errorMessages)
    {
      switch (fhirMajorVersion)
      {
        case Common.Enums.FhirVersion.Stu3:

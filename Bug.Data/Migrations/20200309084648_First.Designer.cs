...
namespace Bug.Data.Migrations
{
    ...
    [Migration("20200309084648_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bug.Logic.DomainModel.FhirVersion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 0,
                            Code = "Stu3",
                            Created = new DateTime(2020, 3, 9, 8, 46, 48, 128, DateTimeKind.Utc).AddTicks(9551),
                            Updated = new DateTime(2020, 3, 9, 8, 46, 48, 128, DateTimeKind.Utc).AddTicks(9551)
                        },
                        new
                        {
                            Id = 1,
            ...
            modelBuilder.Entity("Bug.Logic.DomainModel.SearchParameterResourceName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("SearchParameterResourceName");
                });

            modelBuilder.Entity("Bug.Logic.DomainModel.SearchParameterTargetResourceName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("SearchParameterTargetResourceName");
                });
            ...
            modelBuilder.Entity("Bug.Logic.DomainModel.SearchParameterTargetResourceName", b =>
                {
                    ...
                    b.HasOne("Bug.Logic.DomainModel.SearchParameter", "SearchParameter")
                        .WithMany("TargetResourceNameList")
                        .HasForeignKey("FkSearchParameterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

...
{
  public static class IndexTokenPredicateFactory
  {
    public static Expression<Func<ResourceStore, bool>> TokenIndex(SearchQueryToken SearchQueryToken)
    {
    ...
    private static Expression<Func<ResourceStore, bool>> AnyIndex(Expression<Func<IndexToken, bool>> Predicate)
    {
      return x => x.TokenIndexList.Any(Predicate.Compile());
    }
    private static Expression<Func<ResourceStore, bool>> AnyIndexEquals(Expression<Func<IndexToken, bool>> Predicate, bool Equals)
    {

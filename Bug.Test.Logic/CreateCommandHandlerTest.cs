...
using Bug.Logic.Command.FhirApi.Create.Decorator;
...
namespace Bug.Test.Logic
{
  ...
  public class CreateCommandTest
  {
    ...
    public async void CreateCommandHandler(string Resource, string ResourceId, string ResourceVersionId, FhirMajorVersion FhirMajorVersion)
    {
      ...
      // Act
      CreateCommandHandler CommandHandler = new CreateCommandHandler(IResourceStoreRepositoryMock.Object, IStu3SerializationToJsonBytesMock.Object, IR4SerializationToJsonBytesMock.Object, IGZipperMock.Object);
    ...
    {
      // Prepare           
      Mock<ICommandHandler<CreateCommand, FhirApiOutcome>> ICommandHandlerMock = new Mock<ICommandHandler<CreateCommand, FhirApiOutcome>>();
      ICommandHandlerMock.Setup(x => x.Handle(It.IsAny<CreateCommand>()));     
      ...
      // Act
      var CommandDecorator = new CreateDataCollectionDecorator<CreateCommand, FhirApiOutcome>(ICommandHandlerMock.Object, IFhirResourceIdSupportFactoryMock.Object, IFhirResourceVersionSupportFactoryMock.Object, IFhirResourceLastUpdatedSupportFactoryMock.Object);
